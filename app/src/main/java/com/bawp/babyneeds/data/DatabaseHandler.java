...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public DatabaseHandler(@Nullable Context context) {            //constructor
        super(context, Constants.DB_NAME, null, Constants.DB_VERSION);
        this.context = context;
    }

    @Override
    public void onCreate(SQLiteDatabase db) {                     //on create method to create database table
        String CREATE_BABY_TABLE = "CREATE TABLE " + Constants.TABLE_NAME + "("     //the command "CREATE TABLE" is to use
                                                                                    // for creating table in SQLite
        ...
        db.execSQL(CREATE_BABY_TABLE);             // final call to call the table

    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {  //for upgrade the table contents
    ...
    public Item getItem(int id) {
        ...
        Item item = new Item(); // creating an item object
        if (cursor != null) {
